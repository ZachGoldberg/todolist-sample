...
CREATE TABLE "api_todoitem" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "title" varchar(128) NOT NULL, "description" text NULL, "due_date" datetime NULL, "added" datetime NOT NULL, "status" bool NOT NULL, "owner_id" integer NOT NULL REFERENCES "auth_user" ("id"));
CREATE TABLE "api_todoattachment" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "data" text NOT NULL, "todoitem_id" integer NOT NULL REFERENCES "api_todoitem" ("id"));
CREATE INDEX "api_todoitem_5e7b1936" ON "api_todoitem" ("owner_id");
CREATE INDEX "api_todoattachment_63fa0c44" ON "api_todoattachment" ("todoitem_id");
